...
type BetakeysServiceClient interface {
	NotifyRegionalServers(ctx context.Context, in *KeyNotification, opts ...grpc.CallOption) (*emptypb.Empty, error)
	SendResponseToRegionalServer(ctx context.Context, in *ResponseToRegionalServer, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *betakeysServiceClient) NotifyRegionalServers(ctx context.Context, in *KeyNotification, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, BetakeysService_NotifyRegionalServers_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *betakeysServiceClient) SendResponseToRegionalServer(ctx context.Context, in *ResponseToRegionalServer, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, BetakeysService_SendResponseToRegionalServer_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BetakeysServiceServer interface {
	NotifyRegionalServers(context.Context, *KeyNotification) (*emptypb.Empty, error)
	SendResponseToRegionalServer(context.Context, *ResponseToRegionalServer) (*emptypb.Empty, error)
...
func (UnimplementedBetakeysServiceServer) NotifyRegionalServers(context.Context, *KeyNotification) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method NotifyRegionalServers not implemented")
}
func (UnimplementedBetakeysServiceServer) SendResponseToRegionalServer(context.Context, *ResponseToRegionalServer) (*emptypb.Empty, error) {
...
func _BetakeysService_NotifyRegionalServers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BetakeysService_NotifyRegionalServers_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _BetakeysService_SendResponseToRegionalServer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BetakeysService_SendResponseToRegionalServer_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
